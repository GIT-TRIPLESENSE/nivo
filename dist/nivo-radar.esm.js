...
import { useTheme, useMotionConfig, SmartMotion, blendModePropType, positionFromAngle, radiansToDegrees, noop, getLabelGenerator, DotsItem, closedCurvePropType, motionPropTypes, withContainer, getAccessorFor, useDimensions, useCurveInterpolation, SvgWrapper, ResponsiveWrapper } from '@nivo/core';
...
var enhance$1 = compose(withPropsOnChange(['datum', 'onClick'], function (_ref2) {
  var data = _ref2.datum,
...
var RadarTooltipItem$1 = enhance$1(RadarTooltipItem);
...
var RadarTooltip = memo(function (_ref) {
  ...
  return React.createElement("g", null, data.map(function (d) {
    ...
    return React.createElement(RadarTooltipItem$1, {
      key: index,
      datum: d,
      keys: keys,
      index: index,
